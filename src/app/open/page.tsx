  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-2">
      ...
      <main className="flex flex-col mt-4 mb-2">
        {customer ? (
          <div className="bg-zinc-800 py-6 px-4 rounded border-2 border-zinc-900 flex items-center justify-between">
          ...
          <form
            className="bg-zinc-800 py-6 px-2 rounded border-2 border-zinc-900"
          ...
          >
            <div className="flex flex-col gap-3">
              <Input
                ...
                register={register}
              />
              <button type="submit" className="bg-blue-500 flex flex-row gap-3 px-2 h-11 items-center justify-center rounded font-bold">
                Procurar cliente
